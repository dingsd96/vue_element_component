    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            */
            ...
            this.maxFlareCount = options.maxFlareCount || 99;
        ...
        _createSingle: function (single) {
           ...
           // var graphic = new Graphic(point, null, attributes, null);
            var url = attributes.icon;
            var defaultSym = new DCI.esri.PictureMarkerSymbol({
                "url":url,
                "height":20,
                "width":20
            });
            var graphic = new Graphic(point, defaultSym, attributes, null);
        ...
        _createClusterGraphic: function (cluster) {
            ...
            //create a group element to hold the cluster a
            // nd text and other things
